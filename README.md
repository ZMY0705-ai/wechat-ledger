...
记账真正卡住人的，从来不是「不想记」，而是**记的那一下太麻烦**。

- 记账 App 记一笔，要点开 App、选类型、选分类、输金额、保存，五六步起步。
  地铁上买瓶水，等你想起来记，已经想不起多少钱了。
- 钱还散在各处：微信支付、支付宝、好几张银行卡，每个 App 各记各的。
  月底想知道「这个月到底花哪了」，得挨个翻账单。
- 最麻烦的是分类。账单只会告诉你「转账 35 元」，不会告诉你这是午饭、打车还是给朋友的红包。
  拉出来一长串流水，还是笔糊涂账。

可**微信是一直开着的**。既然每天本来就在微信里说话，那记账不如就在那儿说一句：

> 午饭 35

一句话说完，剩下的交给它：自动分辨收支、自动归类、自动算账，电脑上的页面实时跟着更新。
